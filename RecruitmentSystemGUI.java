    ...
    public RecruitmentSystemGUI() {
        ...
        loginButton.addActionListener(e -> {
            ...
            if (user.equals(Username) && pass.equals(Password)) {
                ...
                cardLayout.show(mainPanel, "menu"); // or whatever panel you want
            } else {
        ...
        menuTitle.setFont(new Font("Arial", Font.BOLD, 100));
                    ...
                    if (id <= 0 || id > applicantIDCounter - 1) {
                        ...
                        if (applicantInfo == null) {
                            ...
                            if (service1.isSelected()) {
                                serviceChosen = "Resume & CV Writing ($50)";
                                agencyFee = 50;
                            } else if (service2.isSelected()) {
                                serviceChosen = "Interview Coaching ($60)";
                                agencyFee = 60;
                            } else if (service3.isSelected()) {
                                serviceChosen = "Language Training ($70)";
                                agencyFee = 70;
                            }
        ...
        applicantPanel.add(label("Full Name:"));
        applicantPanel.add(nameField);
        applicantPanel.add(label("Age:"));
        applicantPanel.add(ageField);
        applicantPanel.add(label("Email:"));
        applicantPanel.add(emailField);
        applicantPanel.add(label("Phone:"));
        applicantPanel.add(phoneField);
        applicantPanel.add(label("Education:"));
        applicantPanel.add(eduBox);
        ...
        applicantPanel.add(birthCertBox);
        applicantPanel.add(idBox);
        applicantPanel.add(medicalBox);
        applicantPanel.add(nbiBox);
        ...
        finishInterviewBtn.addActionListener(e -> {
            ...
            int companyCount = 0;
            try {
                companyCount = Integer.parseInt(companyCountField.getText());
            } catch (Exception ex) {
            }
